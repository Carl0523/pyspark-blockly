...
export default function PySparkEditorPage() {
  ...
  const handleSave = () => {
    ...
    const jsonData = editorRef.current.saveWorkspace();
    ...
    a.href = url;
    a.download = 'pyspark_workspace.json';
  ...
  const handleLoad = () => {
    ...
    input.onchange = (e) => {
      ...
      reader.onload = (event) => {
        ...
        editorRef.current.loadWorkspace(jsonText);
      };
  ...
  const handleHelp = () => {
    alert('PySpark Blockly Editor Help:\n\n' + 
